...
import org.aaa.ssm.service.OrganizationService;
import org.aaa.ssm.service.RoleService;
...
public class UserController {
    ...
    public String test1(Integer id) throws Exception{
    	if(id==1){
    		throw new Exception("实验下");
    	}
    	return "user";
    }
